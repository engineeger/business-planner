...
;// CONCATENATED MODULE: ./assets/source/js/modal.js
...
;// CONCATENATED MODULE: ./assets/source/js/slider.js
...
;// CONCATENATED MODULE: ./assets/source/js/form.js
...
;// CONCATENATED MODULE: ./assets/source/js/menu.js
function menu_scrollChanger() {
    document.body.classList.toggle('no-scroll')
    document.documentElement.classList.toggle('no-scroll')
}
...
function menu () {
    ...
    document.querySelector('.js-menu').addEventListener('click', e => {
        if (e.target.closest('li')) {
            ...
            if (screenWidth <= 992) menu_scrollChanger()
        }
    })
